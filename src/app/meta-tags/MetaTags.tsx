    ...
    return (
        <>
                ...
                <div className="container mx-auto px-4 sm:px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center pt-20 pb-16">
                        ...
                        >
                            ...
                            <TerminalWindow title="meta-tags.html" className="relative z-10 transform -rotate-2 hover:rotate-0 transition-all duration-500">
                                <span className="text-gray-500"># HTML Meta Tags</span>{"\n"}
                                <span className="text-pink-400">{"<meta"}</span> <span className="text-blue-300">name=</span><span className="text-green-300">"description"</span> <span className="text-blue-300">content=</span><span className="text-green-300">"Your docs here"</span><span className="text-pink-400">{">"}</span>{"\n"}
                                <span className="text-pink-400">{"<meta"}</span> <span className="text-blue-300">property=</span><span className="text-green-300">"og:title"</span> <span className="text-blue-300">content=</span><span className="text-green-300">"DocStar"</span><span className="text-pink-400">{">"}</span>{"\n"}
                                <span className="text-pink-400">{"<meta"}</span> <span className="text-blue-300">property=</span><span className="text-green-300">"og:image"</span> <span className="text-blue-300">content=</span><span className="text-green-300">"preview.png"</span><span className="text-pink-400">{">"}</span>{"\n"}
                                <span className="text-pink-400">{"<meta"}</span> <span className="text-blue-300">name=</span><span className="text-green-300">"twitter:card"</span> <span className="text-blue-300">content=</span><span className="text-green-300">"summary"</span><span className="text-pink-400">{">"}</span>
                            </TerminalWindow>
                            ...
                            <div className="absolute -bottom-6 -left-6 p-4 rounded-xl theme-bg-secondary border theme-border shadow-xl flex items-center gap-4 z-20 animate-bounce" style={{ animationDuration: '3s'}}>
                                ...
                                <div>
                                    <p className="text-xs font-bold uppercase tracking-wider">SEO</p>
                                    <p className="text-sm font-medium opacity-80">Optimized</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <div className="container mx-auto">
                    ...
                    <div className="relative z-10 px-4 sm:px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-base md:text-lg opacity-60 max-w-2xl mx-auto">
                                Powerful controls for SEO and social sharing.
                            </p>
                        </div>
                        ...
                        <div className="relative p-8 md:p-12 rounded-3xl bg-[var(--theme-bg)] border theme-border overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-8 relative z-10">
                                <div className="w-12 h-12 rounded-xl bg-[var(--theme-color)]/10 flex items-center justify-center">
                                    <Share2 className="w-6 h-6 text-[var(--theme-color)]" />
                                </div>
                ...
                {/* CTA Section */}
                <CTASection
                    title="Make Your Docs Easy to Find"
                    description="With DocStar's Metadata controls, your documentation doesn't just exist—it gets discovered. Optimize every page, attract the right audience, and maximize the reach of your content."
                />
            </div>
        </>
    );
