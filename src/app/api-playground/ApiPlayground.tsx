    ...
    return (
        <>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center pt-20 pb-16">
                        ...
                        >
                            ...
                            <p className="text-base sm:text-lg opacity-70 mb-8 leading-relaxed max-w-xl">
                                Test endpoints, explore responses, and understand APIs—all in real time without leaving your documentation.
                            </p>
                        ...
                        >
                            ...
                            <TerminalWindow title="api-request.json" className="relative z-10 transform -rotate-2 hover:rotate-0 transition-all duration-500">
                                <span className="text-pink-400">{"{"}</span>{"\n"}
                                {"  "}<span className="text-pink-400">"method"</span>: <span className="text-green-300">"POST"</span>{"\n"}
                                {"  "}<span className="text-pink-400">"endpoint"</span>: <span className="text-blue-300">"/api/users"</span>{"\n"}
                                {"  "}<span className="text-pink-400">"headers"</span>: <span className="text-amber-300">{"{"}</span>{"\n"}
                                {"    "}<span className="text-pink-400">"Authorization"</span>: <span className="text-green-300">"Bearer token"</span>{"\n"}
                                {"  "}<span className="text-amber-300">{"}"}</span>{"\n"}
                                {"  "}<span className="text-pink-400">"body"</span>: <span className="text-amber-300">{"{"}</span>{"\n"}
                                {"    "}<span className="text-pink-400">"name"</span>: <span className="text-green-300">"John Doe"</span>{"\n"}
                                {"    "}<span className="text-pink-400">"email"</span>: <span className="text-green-300">"john@example.com"</span>{"\n"}
                                {"  "}<span className="text-amber-300">{"}"}</span>{"\n"}
                                <span className="text-pink-400">{"}"}</span>
                            </TerminalWindow>
                            ...
                            <div className="absolute -bottom-6 -left-6 p-4 rounded-xl theme-bg-secondary border theme-border shadow-xl flex items-center gap-4 z-20 animate-bounce" style={{ animationDuration: '3s'}}>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium opacity-80">200 OK</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <div className="container mx-auto">
                    ...
                    <div className="relative z-10 px-4 sm:px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-base md:text-lg opacity-60 max-w-2xl mx-auto">
                                Powerful tools that make API testing intuitive and efficient for developers.
                            </p>
                        </div>
                ...
                {/* CTA Section */}
                <CTASection
                    title="Turn API Docs Into Hands-On Experience"
                    description="With DocStar's Interactive API Playground, your API documentation becomes practical and actionable. Developers don't just read—they test, learn, and build with confidence."
                />
            </div>
        </>
    );
