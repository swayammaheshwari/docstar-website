                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center pt-20 pb-16">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border theme-border mb-6 bg-[var(--theme-bg)] shadow-sm backdrop-blur-md">
                                <WebhookIcon className="w-4 h-4 text-[var(--theme-color)]" />
                        ...
                        >
                            ...
                            <TerminalWindow title="webhook-payload.json" className="relative z-10 transform -rotate-2 hover:rotate-0 transition-all duration-500">
                                <span className="text-gray-500">// Webhook Event Payload</span>{"\n"}
                                <span className="text-pink-400">{"{"}</span>{"\n"}
                                <span className="text-gray-300">  "event": <span className="text-green-400">"page.updated"</span>,</span>{"\n"}
                                <span className="text-gray-300">  "timestamp": <span className="text-amber-400">"2024-01-15T10:23:45Z"</span>,</span>{"\n"}
                                <span className="text-gray-300">  "page_id": <span className="text-amber-400">"doc_12345"</span>,</span>{"\n"}
                                <span className="text-gray-300">  "title": <span className="text-green-300">"API Documentation"</span>,</span>{"\n"}
                                <span className="text-gray-300">  "author": <span className="text-green-300">"john.doe"</span>,</span>{"\n"}
                                <span className="text-gray-300">  "changes": <span className="text-pink-400">{"["}</span><span className="text-green-300">content</span><span className="text-pink-400">{", "}</span><span className="text-green-300">title</span><span className="text-pink-400">{"]"}</span></span>{"\n"}
                                <span className="text-pink-400">{"}"}</span>
                            </TerminalWindow>
                            ...
                            <div className="absolute -bottom-6 -left-6 p-4 rounded-xl theme-bg-secondary border theme-border shadow-xl flex items-center gap-4 z-20 animate-bounce" style={{ animationDuration: '3s'}}>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium opacity-80">&lt;100ms</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <div className="container mx-auto">
                    ...
                    <div className="relative z-10 px-4 sm:px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-base md:text-lg opacity-60 max-w-2xl mx-auto">
                                Real-time automation for your documentation.
                            </p>
                        </div>
                ...
                <div className="py-16 md:py-24 px-4 sm:px-6">
                    <div className="max-w-4xl mx-auto relative group">
                        <div className="absolute inset-0 bg-gradient-to-r from-[var(--theme-color)] to-pink-500 rounded-3xl blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-700"></div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 relative z-10">
                                {benefits.map((benefit, index) => (
                                    <div key={index} className="flex items-start gap-4 p-4 rounded-xl theme-bg-secondary border theme-border hover:-translate-y-1 transition-transform duration-300 shadow-sm">
                                        <CheckCircle className="w-6 h-6 flex-shrink-0 text-pink-500 mt-0.5" />
                ...
                {/* CTA Section */}
                <CTASection
                    title="Turn Documentation Events Into Automation"
                    description="With DocStar Webhooks, your documentation becomes part of your automation ecosystem. React to changes in real time, build smarter workflows, and keep everything in sync—without lifting a finger."
                />
            </div>
        </>
    );
