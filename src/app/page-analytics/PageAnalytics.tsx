    ...
    return (
        <>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center pt-20 pb-16">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border theme-border mb-6 bg-[var(--theme-bg)] shadow-sm backdrop-blur-md">
                                <BarChart3 className="w-4 h-4 text-[var(--theme-color)]" />
                            ...
                            <h1 className="h1 mb-6 leading-tight">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-l from-[var(--theme-color)] to-purple-500">
                                    Page Performs.
                                </span>
                            </h1>
                        ...
                        >
                            ...
                            <TerminalWindow title="analytics.json" className="relative z-10 transform -rotate-2 hover:rotate-0 transition-all duration-500">
                                <span className="text-gray-500"># Page Analytics Data</span>{"\n"}
                                <span className="text-pink-400">{"{"}</span>{"\n"}
                                <span className="text-gray-300">  "page": "API Documentation",</span>{"\n"}
                                <span className="text-gray-300">  "status": <span className="text-green-400">"live"</span>,</span>{"\n"}
                                <span className="text-gray-300">  "views": <span className="text-amber-400">12,453</span>,</span>{"\n"}
                                <span className="text-gray-300">  "feedback": <span className="text-amber-400">4.8</span>/5,</span>{"\n"}
                                <span className="text-gray-300">  "seo_score": <span className="text-green-400">92</span>,</span>{"\n"}
                                <span className="text-gray-300">  "utm_clicks": <span className="text-amber-400">3,241</span></span>{"\n"}
                                <span className="text-pink-400">{"}"}</span>
                            </TerminalWindow>
                            ...
                            <div className="absolute -bottom-6 -left-6 p-4 rounded-xl theme-bg-secondary border theme-border shadow-xl flex items-center gap-4 z-20 animate-bounce" style={{ animationDuration: '3s'}}>
                                ...
                                <div>
                                    <p className="text-xs font-bold uppercase tracking-wider">Trend</p>
                                    <p className="text-sm font-medium opacity-80">+24%</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <div className="container mx-auto">
                    ...
                    <div className="relative z-10 px-4 sm:px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-base md:text-lg opacity-60 max-w-2xl mx-auto">
                                Comprehensive insights for data-driven documentation.
                            </p>
                        </div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 relative z-10">
                                {benefits.map((benefit, index) => (
                                    <div key={index} className="flex items-start gap-4 p-4 rounded-xl theme-bg-secondary border theme-border hover:-translate-y-1 transition-transform duration-300 shadow-sm">
                                        <CheckCircle className="w-6 h-6 flex-shrink-0 text-purple-500 mt-0.5" />
                ...
                {/* CTA Section */}
                <CTASection
                    title="Turn Data Into Better Documentation"
                    description="With DocStar's Page Analytics, every page tells a story. Track performance, listen to users, and continuously improve your documentation with insights that actually matter."
                />
            </div>
        </>
    );
