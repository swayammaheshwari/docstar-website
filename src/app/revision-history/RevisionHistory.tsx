    ...
    return (
        <>
                ...
                <div className="container mx-auto px-4 sm:px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center pt-20 pb-16">
                        ...
                        >
                            ...
                            <TerminalWindow title="revision-log.txt" className="relative z-10 transform -rotate-2 hover:rotate-0 transition-all duration-500">
                                <span className="text-gray-500"># Revision History</span>{"\n"}
                                <span className="text-blue-400">[2024-01-15 10:23:45]</span> <span className="text-green-400">v1.0</span> <span className="text-amber-300">CREATED</span> <span className="text-gray-300">"API Docs"</span>{"\n"}
                                <span className="text-blue-400">[2024-01-15 11:30:12]</span> <span className="text-green-400">v1.1</span> <span className="text-amber-300">EDITED</span> <span className="text-gray-300">"Updated auth section"</span>{"\n"}
                                <span className="text-blue-400">[2024-01-15 14:45:03]</span> <span className="text-green-400">v1.2</span> <span className="text-amber-300">PUBLISHED</span> <span className="text-gray-300">"Live version"</span>{"\n"}
                                <span className="text-blue-400">[2024-01-15 16:20:45]</span> <span className="text-green-400">v1.3</span> <span className="text-amber-300">REVERTED</span> <span className="text-gray-300">"Back to v1.1"</span>
                            </TerminalWindow>
                            ...
                            <div className="absolute -bottom-6 -left-6 p-4 rounded-xl theme-bg-secondary border theme-border shadow-xl flex items-center gap-4 z-20 animate-bounce" style={{ animationDuration: '3s'}}>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium opacity-80">Protected</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <div className="container mx-auto">
                    ...
                    <div className="relative z-10 px-4 sm:px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-base md:text-lg opacity-60 max-w-2xl mx-auto">
                                Complete tracking for full transparency.
                            </p>
                        </div>
                ...
                {/* CTA Section */}
                <CTASection
                    title="Never Lose Track of Changes"
                    description="With DocStar's Revision History, your documentation always has a memory. Track every update, stay in control, and collaborate without second-guessing."
                />
            </div>
        </>
    );
