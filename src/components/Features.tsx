...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
     ...
     description: 'Allows you the flexibility to use various web addresses for your Techdoc',
    ...
    <section id="features" className="py-20 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Powerful tools designed to help you create, collaborate, and publish content that makes an impact.
          </motion.p>
        </motion.div>

        <motion.div 
          ref={ref}
          className="grid md:grid-cols-3 gap-8 lg:gap-12 max-w-4xl mx-auto"
          initial={{ opacity: 0, y: 30 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
